...
struct DiscoverDetailView: View {
    ...
    private var ratingSection: some View? {
        ...
        return HStack(spacing: AppSpace._8) {
        ...
        .accessibilityLabel(detail.ratingAccessibilityLabel(baseKey: "detail.rating.accessibility") ?? "")
    ...
    private var metadataSection: some View? {
        ...
        .accessibilityElement(children: .ignore)
        .accessibilityLabel(Text(entries.accessibilityLabel))
